...
--selection by filtering row
select*from employees where job_id=9;

--projection
select first_name,last_name,phone_number from employees where department_id=2;
...
select*from highSalaried;

--select emplaoyee frm all dept except dept_id=9
select* from employees where department_id !=9;

--display employee who are hired
select*from employees where hire_date>='1999'
order by hire_date desc;

--display employeeswho are hired in year 2000,1995 and 1997
select*from employees where Year( hire_date) in (2000,1995,1997);

--dispaly employee from dept 5 8 9 10
select*from employees where department_id in(5,8,9,10);


--retruve employee who has salary is between 9000 and 14000
select*from employees where salary between 9000 and 14000;

--select employee who get a salary above 10000 but only from dept 8 and 10
select *from employees where salary>10000
and department_id in(8 ,10);

--display employee first name and last name whose first_name starts with 'ka'
select first_name,last_name from employees where first_name like'Ka%';
--display employee first name and last name whose first_name starts with 'j and ends with n
select first_name,last_name from employees where first_name like'J%n';
...
select first_name,last_name from employees where first_name like '_a%';
 ...
 --find employee who work in dept 8 5 9 and have salry in range of 5000 and 15000 and only a job id 3 or 1
Select*from employees where department_id IN (8, 5, 9)  AND salary BETWEEN 5000 AND 15000  
...
--dispaly the fist nmae in the asec order of the length of nmae
...
SELECT format(1234567.89,'NO')as formattednumber ;
...
select DATENAME(month,'2024-3-30')
select DATENAME(day,'2024-03-30')
 ...
 select FORMAT(GETDATE(),'dd-MM-YYYY')
  select FORMAT(GETDATE(),'dd-mm-yyyy')
   ...
   --numeric function
select (6/100), cast(6 as decimal(1,0)) / cast(100 as decimal (3,0)),cast (6.0/100.0 as decimal(4,2));
;
...
select convert (varchar(10),'06-04-2025',103);
...
create table demos(value1 int,value2 int,value3 int);
insert into demos(value1,value2,value3)values(11,12,13);
insert into demos(value2,value3)values(12,13);
insert into demos(value1,value3)values(11,13);
select*from demos;
select*from demos where value1   is null;

select isnull (value1,100) from demos

create table demo2(contact1 varchar(10),contact2 varchar(10),contact3 varchar(10));
...
--display total saley obtained by each department
select department_id,sum(salary) from employees group by department_id;

select department_id,sum(salary) from employees group by department_id
having department_id in (5,8,9);
select count(*) from employees;
select count(employee_id) from employees
--display the total salary obtained by eachdept in asc order
select department_id,sum(salary) as total_salary from employees 
group by department_id
order by total_salary asc;


--display the total no of employee in each dept
select  department_id,count(*) as total_employee from employees group by department_id;


--display the department_id and salaryfor which the sum of salary is highest
select top 1 department_id,sum(salary) as total_salary from employees group by department_id order by total_salary desc;

--display name of employee who get highest bsalry
